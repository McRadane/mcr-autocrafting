...
# try to add items
execute if score @s mcrac_ok matches 4 store result score @s mcrac_gave run loot insert ^ ^ ^-1 loot mcr-autocraft:cake_1

# if ok, remove crafting items
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:egg"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t1
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:milk_bucket"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t1
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_3_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:sugar"}].Count short 1 run scoreboard players get @s mcrac_ic_3_t1
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_4_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:wheat"}].Count short 1 run scoreboard players get @s mcrac_ic_4_t1
