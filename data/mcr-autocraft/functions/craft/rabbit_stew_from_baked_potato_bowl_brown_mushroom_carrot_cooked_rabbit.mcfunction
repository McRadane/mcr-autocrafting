...
# try to add items
execute if score @s mcrac_ok matches 5 run function mcr-autocraft:count_empty_slots
...
execute if score @s mcrac_ok matches 5 if score @s mcrac_gave matches 1 run function mcr-autocraft:countslot/brown_mushroom
execute if score @s mcrac_ok matches 5 if score @s mcrac_gave matches 1 run function mcr-autocraft:remove
