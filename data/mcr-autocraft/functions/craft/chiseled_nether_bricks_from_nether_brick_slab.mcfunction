# input 1 : minecraft:nether_brick_slab
...
# calculate costs
function mcr-autocraft:count/nether_brick_slab
...
execute if score @s mcrac_ok matches 1 if score @s empty_slots matches 1.. run loot insert ^ ^ ^-1 loot mcr-autocraft:chiseled_nether_bricks_1
...
execute if score @s mcrac_ok matches 1 if score @s mcrac_gave matches 1 run function mcr-autocraft:countslot/nether_brick_slab
