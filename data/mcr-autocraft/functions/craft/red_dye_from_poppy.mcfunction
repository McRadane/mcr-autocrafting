...
# calculate costs
function mcr-autocraft:count/poppy
...
execute if score @s mcrac_ok matches 1 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:poppy"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t1
