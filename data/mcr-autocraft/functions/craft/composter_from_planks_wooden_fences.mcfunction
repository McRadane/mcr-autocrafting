...
# input 2 : #minecraft:#wooden_fences
...
execute if score @s mcrac_ok matches 2 run function mcr-autocraft:tags/prepare_2_to_6
execute if score @s mcrac_ok matches 2 run function mcr-autocraft:tags/calculate_6
execute if score @s mcrac_ok matches 2 run function mcr-autocraft:tags/return_2_from_6

# try to add items
execute if score @s mcrac_ok matches 2 store result score @s mcrac_gave run loot insert ^ ^ ^-1 loot mcr-autocraft:composter_1
...
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:oak_fence"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t1
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t2_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:acacia_fence"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t2
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t3_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:dark_oak_fence"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t3
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t4_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:spruce_fence"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t4
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t5_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:birch_fence"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t5
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t6_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:jungle_fence"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t6
