# input 1 : #minecraft:#mcr_custom_sand_red_sand
...
function mcr-autocraft:count/red_sand
...
execute if score @s mcrac_ok matches 2 run function mcr-autocraft:tags/prepare_1_to_2
execute if score @s mcrac_ok matches 2 run function mcr-autocraft:tags/calculate_2
execute if score @s mcrac_ok matches 2 run function mcr-autocraft:tags/return_1_from_2
...
# try to add items
execute if score @s mcrac_ok matches 2 store result score @s mcrac_gave run loot insert ^ ^ ^-1 loot mcr-autocraft:tnt_1

# if ok, remove crafting items
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:sand"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t1
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t2_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:red_sand"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t2
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:gunpowder"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t1
