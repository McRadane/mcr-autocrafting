...
execute if score @s mcrac_ok matches 5 if score @s mcrac_gave matches 1 if score @s mcrac_ic_3_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:carrot"}].Count short 1 run scoreboard players get @s mcrac_ic_3_t1
execute if score @s mcrac_ok matches 5 if score @s mcrac_gave matches 1 if score @s mcrac_ic_4_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:cooked_rabbit"}].Count short 1 run scoreboard players get @s mcrac_ic_4_t1
execute if score @s mcrac_ok matches 5 if score @s mcrac_gave matches 1 if score @s mcrac_ic_5_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:red_mushroom"}].Count short 1 run scoreboard players get @s mcrac_ic_5_t1
