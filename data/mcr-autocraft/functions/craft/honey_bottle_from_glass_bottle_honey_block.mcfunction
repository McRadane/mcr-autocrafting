...
# calculate costs
function mcr-autocraft:count/glass_bottle
scoreboard players operation @s mcrac_ic_1 += @s mcrac_tt

function mcr-autocraft:count/honey_block
...
execute if score @s mcrac_ok matches 2 if score @s empty_slots matches 1.. run loot insert ^ ^ ^-1 loot mcr-autocraft:honey_bottle_4
...
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 run function mcr-autocraft:countslot/glass_bottle
...
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 run function mcr-autocraft:countslot/honey_block
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 run function mcr-autocraft:remove
