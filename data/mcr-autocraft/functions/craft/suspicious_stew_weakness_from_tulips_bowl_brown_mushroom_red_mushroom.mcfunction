...
# calculate costs
function mcr-autocraft:count/red_tulip
scoreboard players operation @s mcrac_ic_1 += @s mcrac_tt

function mcr-autocraft:count/orange_tulip
scoreboard players operation @s mcrac_ic_1 += @s mcrac_tt

function mcr-autocraft:count/white_tulip
scoreboard players operation @s mcrac_ic_1 += @s mcrac_tt

function mcr-autocraft:count/pink_tulip
scoreboard players operation @s mcrac_ic_1 += @s mcrac_tt
...
execute if score @s mcrac_ok matches 4 if score @s empty_slots matches 1.. run loot insert ^ ^ ^-1 loot mcr-autocraft:suspicious_stew_weakness_1
...
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 run function mcr-autocraft:countslot/tulips
