...
execute if score @s mcrac_ok matches 4 run function mcr-autocraft:tags/prepare_1_to_6
execute if score @s mcrac_ok matches 4 run function mcr-autocraft:tags/calculate_6
execute if score @s mcrac_ok matches 4 run function mcr-autocraft:tags/return_1_from_6
...
# try to add items
execute if score @s mcrac_ok matches 4 store result score @s mcrac_gave run loot insert ^ ^ ^-1 loot mcr-autocraft:piston_1

# if ok, remove crafting items
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:oak_planks"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t1
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t2_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:spruce_planks"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t2
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t3_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:birch_planks"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t3
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t4_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:jungle_planks"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t4
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t5_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:acacia_planks"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t5
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_1_t6_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:dark_oak_planks"}].Count short 1 run scoreboard players get @s mcrac_ic_1_t6
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:cobblestone"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t1
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_3_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:iron_ingot"}].Count short 1 run scoreboard players get @s mcrac_ic_3_t1
execute if score @s mcrac_ok matches 4 if score @s mcrac_gave matches 1 if score @s mcrac_ic_4_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:redstone"}].Count short 1 run scoreboard players get @s mcrac_ic_4_t1
