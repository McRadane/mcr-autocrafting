...
# input 2 : #minecraft:#wooden_slabs
scoreboard players set @s mcrac_ic_2 0
scoreboard players set @s mcrac_n_2 2
...
# try to add items
execute if score @s mcrac_ok matches 2 store result score @s mcrac_gave run loot insert ^ ^ ^-1 loot mcr-autocraft:barrel_1
...
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t1_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:oak_slab"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t1
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t2_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:spruce_slab"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t2
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t3_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:birch_slab"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t3
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t4_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:jungle_slab"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t4
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t5_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:acacia_slab"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t5
execute if score @s mcrac_ok matches 2 if score @s mcrac_gave matches 1 if score @s mcrac_ic_2_t6_d matches 1 store result block ^ ^ ^-1 Items[{id:"minecraft:dark_oak_slab"}].Count short 1 run scoreboard players get @s mcrac_ic_2_t6
