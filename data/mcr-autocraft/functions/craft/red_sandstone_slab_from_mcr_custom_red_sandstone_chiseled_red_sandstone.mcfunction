# input 1 : #minecraft:#mcr_custom_red_sandstone_chiseled_red_sandstone
...
# try to add items
execute if score @s mcrac_ok matches 1 store result score @s mcrac_gave run loot insert ^ ^ ^-1 loot mcr-autocraft:red_sandstone_slab_6
