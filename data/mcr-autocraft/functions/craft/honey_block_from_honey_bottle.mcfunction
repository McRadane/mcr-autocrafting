# input 1 : minecraft:honey_bottle
...
# calculate costs
function mcr-autocraft:count/honey_bottle
...
execute if score @s mcrac_ok matches 1 if score @s empty_slots matches 2.. run loot insert ^ ^ ^-1 loot mcr-autocraft:honey_block_1
execute if score @s mcrac_ok matches 1 if score @s empty_slots matches 2.. run loot insert ^ ^ ^-1 loot mcr-autocraft:glass_bottle_4
execute if score @s mcrac_ok matches 1 if score @s empty_slots matches 2.. run scoreboard players set @s mcrac_gave 1

# if ok, remove crafting items
scoreboard players operation @s item_need = @s mcrac_n_1
execute if score @s mcrac_ok matches 1 if score @s mcrac_gave matches 1 run function mcr-autocraft:countslot/honey_bottle
